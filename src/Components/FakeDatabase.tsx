...
const generateFakeData = (): {
  ...
  function getAvatar(gender: string) {
    return `https://randomuser.me/api/portraits/${gender}/${randomNumber(
      0,
      99
    )}.jpg`;
  }
  ...
  function generateCandidate(): ICandidate {
    let male = Math.random() < 0.7;
    let candidateName = male
      ? maleFirstNames[randomNumber(0, maleFirstNames.length - 1)]
      : femaleFirstNames[randomNumber(0, femaleFirstNames.length - 1)];
    candidateName += " " + lastNames[randomNumber(0, lastNames.length - 1)];
    const candidate: ICandidate = {
      id: genId(),
      name: candidateName,
      avatar: getAvatar(male ? "men" : "women"),
